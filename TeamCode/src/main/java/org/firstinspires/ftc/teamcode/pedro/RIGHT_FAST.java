...
@Autonomous(name = "FAST_6_RIGHT", group = "Examples")
public class RIGHT_FAST extends OpMode {
    ...
    private final Pose scorePose = new Pose(70, 41, Math.toRadians(270));
    private final Pose takePose = new Pose(114, 12.5, Math.toRadians(270));

    private final Pose prepBasket = new Pose(112, 13, Math.toRadians(0));
    ...
    private final Pose pickup3 = new Pose(114, 30, Math.toRadians(270));
    private final Pose pickup4 = new Pose(122, 46, Math.toRadians(270));
    ...
    private final Pose pickup8 = new Pose(122, 30, Math.toRadians(270));

    private final Pose basket = new Pose(17.5, 17.5, Math.toRadians(45));
    ...
    public void buildPaths() {
        ...
        grab1 = follower.pathBuilder()
                ...
                .addPath(new BezierLine(new Point(pickup7), new Point(PREPtakePose)))
                .setLinearHeadingInterpolation(pickup7.getHeading(), PREPtakePose.getHeading())
                ...
                .addPath(new BezierLine(new Point(takePose), new Point(basket)))
                .setLinearHeadingInterpolation(takePose.getHeading(), basket.getHeading())
