...
//@Autonomous(name = "RIGHT_6_EXTEND", group = "Examples")
public class RIGHT_PrintesaDinDubai extends OpMode {
    ...
    private final Pose pickupHATZ = new Pose(100, 20, Math.toRadians(0));

    private final Pose basket = new Pose(14, 13, Math.toRadians(0));

    /* These are our Paths and PathChains that we will define in buildPaths() */
    private Path scorePreload;

    private PathChain grab1 , grab2 , grab3 , prepSpec , scoreSpec , takeSpec, placeInBasket;
    ...
    public void buildPaths() {
        ...
        takeSpec = follower.pathBuilder()
                .addPath(new BezierLine(new Point(scorePose), new Point(pickupHATZ)))
                .setLinearHeadingInterpolation(scorePose.getHeading(), pickupHATZ.getHeading())
        ...
        placeInBasket = follower.pathBuilder()
                .addPath(new BezierLine(new Point(pickupHATZ), new Point(basket)))
                .setLinearHeadingInterpolation(pickupHATZ.getHeading(), basket.getHeading())
        ...
        grab1 = follower.pathBuilder()
                ...
                .addPath(new BezierLine(new Point(pickup7), new Point(takePose)))
                .setLinearHeadingInterpolation(pickup7.getHeading(), takePose.getHeading())
                .build();
        ...
        scoreSpec = follower.pathBuilder()
                ...
                .addPath(new BezierLine(new Point(takePose), new Point(pickupHATZ)))
                .setLinearHeadingInterpolation(takePose.getHeading(), pickupHATZ.getHeading())
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 3:
                if(!follower.isBusy()) {
                    giveSpecimen3();
                    follower.followPath(placeInBasket, false);
                    setPathState(4);
                }
                break;
            case 4:
