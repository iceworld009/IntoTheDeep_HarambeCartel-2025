...
public class RIGHT_5_PUSH extends OpMode {
    ...
    private final Pose scorePose = new Pose(74, 43, Math.toRadians(270));

    /** Lowest (First) Sample from the Spike Mark */

    private final Pose pickup0 = new Pose(74, 39, Math.toRadians(270));
    private final Pose pickup1 = new Pose(110, 35, Math.toRadians(270));
    private final Pose pickup2 = new Pose(105, 63, Math.toRadians(270));
    private final Pose pickup3 = new Pose(115, 63, Math.toRadians(270));
    private final Pose pickup4 = new Pose(115, 30, Math.toRadians(270));
    private final Pose pickup5 = new Pose(125, 63, Math.toRadians(270));
    private final Pose pickup6 = new Pose(125, 30, Math.toRadians(270));
    private final Pose pickup7 = new Pose(130, 63, Math.toRadians(270));
    private final Pose pickup8 = new Pose(130, 30, Math.toRadians(270));



    /** Park Pose for our robot, after we do all of the scoring. */
    private final Pose takePose = new Pose(118, 12, Math.toRadians(270));

    /* These are our Paths and PathChains that we will define in buildPaths() */
    private Path scorePreload;

    private PathChain grab1 , grab2 , grab3, grab4, grab5, prepSpec , scoreSpec , takeSpec;
    ...
    public void buildPaths() {
        ...
        grab1 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(scorePose), new Point(pickup0)))
                .setLinearHeadingInterpolation(scorePose.getHeading(), pickup0.getHeading())
                .addPath(new BezierLine(new Point(pickup0), new Point(pickup1)))
                .setLinearHeadingInterpolation(pickup0.getHeading(), pickup1.getHeading())
        ...
        grab2 = follower.pathBuilder()
                ...
                .addPath(new BezierLine(new Point(pickup4), new Point(pickup3)))
                .setLinearHeadingInterpolation(pickup4.getHeading(), pickup3.getHeading())
                .build();

        grab3 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(pickup3), new Point(pickup5)))
                .setLinearHeadingInterpolation(pickup3.getHeading(), pickup5.getHeading())
                ...
                .addPath(new BezierLine(new Point(pickup6), new Point(pickup5)))
                .setLinearHeadingInterpolation(pickup6.getHeading(), pickup5.getHeading())
                .build();

        grab4 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(pickup5), new Point(pickup7)))
                .setLinearHeadingInterpolation(pickup5.getHeading(), pickup7.getHeading())
                .addPath(new BezierLine(new Point(pickup7), new Point(pickup8)))
                .setLinearHeadingInterpolation(pickup7.getHeading(), pickup8.getHeading())
                .addPath(new BezierLine(new Point(pickup8), new Point(takePose)))
                .setLinearHeadingInterpolation(pickup8.getHeading(), takePose.getHeading())
                .build();
        ...
        scoreSpec = follower.pathBuilder()
                ...
                .addPath(new BezierLine(new Point(scorePose), new Point(takePose)))
                .setLinearHeadingInterpolation(scorePose.getHeading(), takePose.getHeading())
