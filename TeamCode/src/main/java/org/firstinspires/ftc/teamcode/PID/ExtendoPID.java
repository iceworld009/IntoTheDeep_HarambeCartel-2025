...
public class ExtendoPID implements Runnable{
    ...
    private static ExtendoPID single_instance = null;
     ...
     */
    public ExtendoPID(DcMotorEx motor1, String motorName, String threadName, Telemetry telemetry){
        this.motor1 = motor1;
    ...
    public ExtendoPID(DcMotorEx motor1,
                      double kp,
                      double ki,
                      double kd,
                      double reference,
    ...
    public static synchronized ExtendoPID getInstance(DcMotorEx motor1, String motorName, String threadName, Telemetry telemetry){
        if(single_instance == null){
            single_instance = new ExtendoPID(motor1,motorName  , threadName,telemetry);
        }
