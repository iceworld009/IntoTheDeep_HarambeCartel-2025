...
@Autonomous(name = "6_RIGHT", group = "Examples")
public class RIGHT_PumnuMeuBetonArmat extends OpMode {
    ...
    private final Pose takePose = new Pose(112, 12.5, Math.toRadians(270));
    ...
    private final Pose basket = new Pose(17, 11, Math.toRadians(0));
