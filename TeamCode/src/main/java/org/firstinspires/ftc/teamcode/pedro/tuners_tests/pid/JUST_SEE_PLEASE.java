...
//@Autonomous(name = "AM INNEBUNIT", group = "Examples")
public class JUST_SEE_PLEASE extends OpMode {
    ...
    private final Pose parkPose = new Pose(45, 62, Math.toRadians(0));

    private final Pose parkPose2 = new Pose(30, 62, Math.toRadians(0));

    /* These are our Paths and PathChains that we will define in buildPaths() */
    private Path scorePreload,grabPickup1, grabPickup2, grabPickup3, scorePickup1, scorePickup2, scorePickup3, park2;

    private PathChain grab1 , grab2 , grab3 , parkPath , placeFOUND , takeFisrt, placeP,restart, place1 , place2,place3 , park;
    ...
    public void buildPaths() {
        ...
        takeFisrt = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(startPose), new Point(parkPose2)))
                .setLinearHeadingInterpolation(startPose.getHeading(), parkPose2.getHeading())
                .addParametricCallback(0 , () -> {
                    servos.placeInBasket();
                    slidesBackInRobot();
                })
